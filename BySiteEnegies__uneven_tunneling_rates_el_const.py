...
GammaL = 10 * kB * T * width
GammaR1 = 20 * kB * T * width  # IN
GammaR2 = 10 * kB * T * width  # OUT
...
V0 = U / 10
Vset = [0, 2*V0, 5*V0, 7*V0]  # 0.2*V0, 0.5*V0, 0.7*V0
...
plt.title("Right dot population along $\epsilon_{L}$ = " + str(VL) + "euV\n"
